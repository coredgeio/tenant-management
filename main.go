...
func main() {
	...
	apiConfig.RegisterTenantManagementServer(grpcServer, server.NewTenantManagementServer())
	...
	err = apiConfig.RegisterTenantManagementHandler(context.Background(), gwmux, conn)
	if err != nil {
