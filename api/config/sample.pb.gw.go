...
var (
	pattern_SampleApi_HelloWorld_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 1}, []string{"v1", "project"}, ""))
)

var (
	forward_SampleApi_HelloWorld_0 = runtime.ForwardResponseMessage
)
